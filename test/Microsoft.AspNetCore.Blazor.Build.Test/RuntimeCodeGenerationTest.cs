...
<div>
        ...
        public void RazorTemplate_InCodeBlock()
        {
            ...
            var generated = CompileToCSharp(@"
@{
    RenderFragment<Person> p = @<div>@item.Name</div>;
}
@functions {
    class Person
    {
        ...
        public void RazorTemplate_InExplicitExpression()
        {
            ...
            // Act
            var generated = CompileToCSharp(@"
@(RenderPerson(@<div>@item.Name</div>))
@functions {
    class Person
    {
        public string Name { get; set; }
...
@addTagHelper ""*, TestAssembly""
@{
    RenderFragment<Person> p = @<div><MyComponent Name=""@item.Name""/></div>;
}
@functions {
    class Person
    {
...
"));
            ...
            var generated = CompileToCSharp(@"
@addTagHelper ""*, TestAssembly""
<MyComponent PersonTemplate=""@(@<div>@item.Name</div>)""/>
");
...
"));
            ...
            var generated = CompileToCSharp(@"
@addTagHelper ""*, TestAssembly""
<MyComponent Template=""@(@<li>#@item.Index - @item.Item.ToLower()</li>)""/>
");
